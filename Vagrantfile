...
Vagrant.configure("2") do |config|
    ...
    config.vm.provision :shell, :inline => "cd /opt/stack/; sudo git clone https://github.com/stackforge/python-solumclient.git"
    config.vm.provision :shell, :inline => "sudo easy_install -U setuptools"
